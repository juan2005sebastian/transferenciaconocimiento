          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Sebastian olmos</h3>

                <p class="text-muted text-center">Aprendiz </p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Seguidores</b> <a class="float-right">2,852</a>
                  </li>
                  <li class="list-group-item">
                    <b>Seguidos</b> <a class="float-right">853</a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  ...
                  <span class="tag tag-success">SQL</span>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="../dist/img/satu.png" alt="user image">
                        <span class="username">
